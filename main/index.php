...
<div class="relative h-screen flex items-center justify-center bg-cover bg-center" style="background-image: url('images/grills.png');">
    ...
    <div class="relative z-10 text-center text-white p-4">
        ...
        <p class="text-xl mb-8 text-gray-300">De beste custom-fitted grillz van Nederland. Goud, Zilver & VVS Diamanten.</p>
        <a href="#producten" class="bg-gold text-gray-900 font-bold py-3 px-8 rounded-full shadow-lg hover:bg-yellow-500 transition transform hover:scale-105">
            Bekijk Collectie
        </a>
    </div>
</div>
